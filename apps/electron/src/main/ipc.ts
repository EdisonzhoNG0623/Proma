...
import { registerRemoteHostIpcHandlers } from './lib/remote-host/remote-host-ipc-handlers'
...
export function registerIpcHandlers(): void {
  ...
  // Remote Host owns a separate IPC namespace.
  registerRemoteHostIpcHandlers()
}

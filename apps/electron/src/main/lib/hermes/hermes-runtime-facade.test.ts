...
import { HermesRuntimeFacade, resolveHermesSessionFilePath, type HermesRuntimeDeps, type HermesRuntimeQueryInput, type HermesSessionBinding, validateHermesTurnAttachments } from './hermes-runtime-facade'
...
const input = (overrides: Partial<HermesRuntimeQueryInput> = {}): HermesRuntimeQueryInput => ({

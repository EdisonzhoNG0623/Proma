...
import { agentLiveMessagesAtomFamily, agentSessionStreamingStateAtomFamily, agentSessionsAtom, type AgentStreamState } from '@/atoms/agent-atoms'
...
export const AgentMessages = React.memo(function AgentMessages({
  ...
  const allSDKMessages = React.useMemo(() => {
    ...
    if (isHermesSession) {
      return live.length > 0 ? live : persisted
    }
    ...
    return result
  }, [isHermesSession, persistedSDKMessages, liveMessages])

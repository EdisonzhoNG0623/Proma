...
export interface Automation {
   ...
   */
  maxRuns?: number
  /** 本任务运行时使用的本地 Agent runtime；Hermes Remote 不参与 Automation。 */
  agentRuntime?: import('./agent-provider').LocalAgentRuntime
  /** AI 渠道 ID */
  channelId: string
...
export interface CreateAutomationInput {
  ...
  maxRuns?: number
  /** 本任务运行时使用的本地 Agent runtime；新建任务不传则为 pi。 */
  agentRuntime?: import('./agent-provider').LocalAgentRuntime
  channelId: string
  modelId?: string
  workspaceId?: string
